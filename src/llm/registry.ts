...
const REGISTRY: ModelInfo[] = [
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.5',
    label: 'OpenAI - GPT-5.5 (Medium)',
    shortLabel: 'GPT 5.5 Medium',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'medium',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.5',
    label: 'OpenAI - GPT-5.5 (None)',
    shortLabel: 'GPT 5.5 None',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: false },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'none',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.4',
    label: 'OpenAI - GPT-5.4 (Medium)',
    shortLabel: 'GPT 5.4 Medium',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'medium',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.4',
    label: 'OpenAI - GPT-5.4 (Low)',
    shortLabel: 'GPT 5.4 Low',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: false },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'low',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.4',
    label: 'OpenAI - GPT-5.4 (Minimal)',
    shortLabel: 'GPT 5.4 Minimal',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: false },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'minimal',
  ...
  },
  {
    ...
    label: 'OpenAI - GPT-5.4 Pro (xHigh)',
    shortLabel: 'GPT 5.4 Pro xHigh',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'xhigh',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.4-pro',
    label: 'OpenAI - GPT-5.4 Pro (High)',
    shortLabel: 'GPT 5.4 Pro High',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'high',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.4-pro',
    label: 'OpenAI - GPT-5.4 Pro (Medium)',
    shortLabel: 'GPT 5.4 Pro Medium',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'medium',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.4-pro',
    label: 'OpenAI - GPT-5.4 Pro (Low)',
    shortLabel: 'GPT 5.4 Pro Low',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: false },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'low',
  ...
  {
    id: 'gpt-5.4-pro-minimal',
    provider: 'openai',
    apiModel: 'gpt-5.4-pro',
    label: 'OpenAI - GPT-5.4 Pro (Minimal)',
    shortLabel: 'GPT 5.4 Pro Minimal',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: false },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'minimal',
  ...
  },
  {
    ...
    shortLabel: 'Gemini 3.1 Pro High',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: false },
    defaults: { webSearch: true, streaming: true, background: false },
    thinkingLevel: 'high',
...
export const DEFAULT_MODEL_ID: string = 'gpt-5.4-high';

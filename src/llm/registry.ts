...
const REGISTRY: ModelInfo[] = [
  ...
  {
    id: 'gpt-5.2-pro-xhigh',
    provider: 'openai',
    apiModel: 'gpt-5.2-pro',
    label: 'OpenAI - GPT-5.2 Pro (xHigh)',
    shortLabel: 'GPT 5.2 Pro xHigh',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'xhigh',
  ...
  },
  {
    ...
    provider: 'openai',
    apiModel: 'gpt-5.2-pro',
    label: 'OpenAI - GPT-5.2 Pro (High)',
    shortLabel: 'GPT 5.2 Pro High',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'high',
  ...
  {
    id: 'gpt-5.2-pro-medium',
    provider: 'openai',
    apiModel: 'gpt-5.2-pro',
    label: 'OpenAI - GPT-5.2 Pro (Medium)',
    shortLabel: 'GPT 5.2 Pro Medium',
    supportsImageInput: true,
    parameters: { webSearch: true, streaming: true, background: true },
    defaults: { webSearch: true, streaming: true, background: false, verbosity: 'medium' },
    effort: 'medium',
